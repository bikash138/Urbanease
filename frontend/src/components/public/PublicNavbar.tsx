...
export default function PublicNavbar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border-b border-zinc-200/50 dark:border-zinc-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-2 sm:gap-3 md:gap-6 min-w-0">
        <Link
          href="/"
        ...
        >
          ...
          <span className="hidden sm:inline text-xl font-semibold text-zinc-900 tracking-tight">
            Urbanease
          </span>
        </Link>
